...
admin.site.register(models.Vendor, models.AdminVendor)
admin.site.register(models.GoodConsist, models.AdminGoodConsist)
admin.site.register(models.Colour, models.AdminColour)
